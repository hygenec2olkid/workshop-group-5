...
INSERT INTO cart (user_id, discount_id, total, discount) VALUES(3,NULL,21010.5,0);

INSERT INTO cart_item(cart_session ,product_id ,quantity ,sub_total ,product_sku ,discount ,promotion_code )
VALUES (1,1,1,20990.25,'MOBILE-APPLE-IPHONE-12-PRO',0,'');

INSERT INTO cart_item(cart_session ,product_id ,quantity ,sub_total ,product_sku ,discount ,promotion_code )
VALUES (1,28,1,20.25,'STATIONERY-STAPLER-SWINGLINE',0,'');
