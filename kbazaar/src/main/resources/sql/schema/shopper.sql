...
ALTER TABLE cart ADD CONSTRAINT cart_promotion_fk FOREIGN KEY (discount_id) REFERENCES promotion(promotion_id);
ALTER TABLE cart ADD CONSTRAINT cart_shopper_fk FOREIGN KEY (user_id) REFERENCES shopper(id);
